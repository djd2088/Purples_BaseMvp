...
public final class AppConfigurator {
    ...
    public final void configFinish(){
        ...
        if (Rui.getConfigWithKey(EAppConfigure.API_HOST.name()) == null){
            Rui.getAppConfigs().put(EAppConfigure.API_HOST.name(),"http://rui.Rui" +
                    ".com");
        }
    ...
    public final AppConfigurator withHost(String host){
        RUI_CONFIGS.put(EAppConfigure.API_HOST.name(),host);
        return this;
    }
